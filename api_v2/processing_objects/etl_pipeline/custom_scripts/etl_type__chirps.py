...
class chirps():
    ...
    # Chirps Has more than 1 mode which refer to sub datasets (chirp, chirps, chirps_gefs)
    chirps_mode = "chirp"  # Choices at this time are "chirp", "chirps", and "chirps_gefs // Controlled by setter functions. // Default is "chirp"
    ...
    def set_chirps_mode__To__chirp(self):
        self.chirps_mode = "chirp"
    def set_chirps_mode__To__chirps(self):
        self.chirps_mode = "chirps"
    def set_chirps_mode__To__chirps_gefs(self):
        self.chirps_mode = "chirps_gefs"

    #def set_chirps_params(self, todo_params):

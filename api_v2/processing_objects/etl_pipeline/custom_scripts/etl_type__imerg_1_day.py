...
# Description Create an instance of the subtype class
# this class must implement each of the pipeline functions for
...
class ImergOneDay:
    ...
    def set_imerg_1day_params(self, start_year, end_year, start_month, end_month, start_day, end_day):
        try:
            self.YYYY__Year__Start = int(start_year)
        except ValueError:
            pass
        try:
            self.YYYY__Year__End = int(end_year)
        except ValueError:
            pass
        try:
            self.MM__Month__Start = int(start_month)
        except ValueError:
            pass
        try:
            self.MM__Month__End = int(end_month)
        except ValueError:
            pass
        try:
            self.DD__Day__Start = int(start_day)
        except ValueError:
            pass
        try:
            self.DD__Day__End = int(end_day)
        except ValueError:
            pass

...
# emodis, stores data in a pattern like this:  wa2019.zip
# # wa = 'West Africa'      # This is the region code
# # 20 = '2020'             # The 2 digit Year
# # 19 = '19th dekadal'     # The 19th file for the year, which means

class emodis():

    class_name = "emodis"

    # Expected Usage of this parent instance prop is for sending Events and Logs back up the pipeline
    ...
    # etl_parent_pipeline_instance.log_etl_event( PARAMS )
    # etl_parent_pipeline_instance.log_etl_error( PARAMS )
    # etl_parent_pipeline_instance.log_etl_granule( PARAMS )
    # etl_parent_pipeline_instance.create_or_update_Available_Granule( PARAMS )
    ...
    # These get appended to the root working directories to make the complete path.
    relative_dir_path__WorkingDir = 'working_dir'
    #relative_dir_path__Download = 'download'
    #relative_dir_path__Extract = 'extract'
    ...
    def set_emodis_params(self, YYYY__Year__Start, YYYY__Year__End, MM__Month__Start, MM__Month__End, XX__Region_Code):
        ...
        try:
            ...
            pass
        try:
            self.XX__Region_Code = str(XX__Region_Code).strip()
        except:
            pass
    ...
    def get_root_local_temp_working_dir(region_code):
        ...
        #emodis__ea__rootoutputworkingdir    = '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/data/image/input/emodis/eastafrica/'
        #
        #
        # emodis__ea__rootoutputworkingdir    = settings.PATH__TEMP_WORKING_DIR__EMODIS__EA # '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/temp_etl_data/emodis/eastafrica/'
        # emodis__wa__rootoutputworkingdir    = settings.PATH__TEMP_WORKING_DIR__EMODIS__WA # '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/temp_etl_data/emodis/westafrica/'
        # emodis__sa__rootoutputworkingdir    = settings.PATH__TEMP_WORKING_DIR__EMODIS__SA # '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/temp_etl_data/emodis/southernafrica/'
        # emodis__cta__rootoutputworkingdir   = settings.PATH__TEMP_WORKING_DIR__EMODIS__CTA # '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/temp_etl_data/emodis/centralasia/'
        #
    ...
    def get_final_load_dir(region_code):
        ...
        # emodis__ea__rootoutputworkingdir    = '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/data/image/input/emodis/eastafrica/'
        #
        # Comes from: https://thredds.servirglobal.net/thredds/catalog/climateserv/emodis-ndvi/eastafrica/250m/10dy/catalog.html
        # thredds/catalog/climateserv/emodis-ndvi/eastafrica/250m/10dy/catalog.html
        # emodis__ea__finalloaddir    = settings.PATH__THREDDS_MONITORING_DIR__EMODIS__EA # '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/THREDDS/thredds/catalog/climateserv/emodis-ndvi/eastafrica/250m/10dy/'
        # emodis__wa__finalloaddir    = settings.PATH__THREDDS_MONITORING_DIR__EMODIS__WA # '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/THREDDS/thredds/catalog/climateserv/emodis-ndvi/westafrica/250m/10dy/'
        # emodis__sa__finalloaddir    = settings.PATH__THREDDS_MONITORING_DIR__EMODIS__SA # '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/THREDDS/thredds/catalog/climateserv/emodis-ndvi/southernafrica/250m/10dy/'
        # emodis__cta__finalloaddir   = settings.PATH__THREDDS_MONITORING_DIR__EMODIS__CTA # '/Volumes/TestData/Data/SERVIR/ClimateSERV_2_0/data/THREDDS/thredds/catalog/climateserv/emodis-ndvi/centralasia/250m/10dy/'
        # #
    ...
    def get_roothttp_for_regioncode(region_code):
        # Type Specific Settings
        # emodis__ea__roothttp    = settings.REMOTE_PATH__ROOT_HTTP__EMODIS__EA # 'https://edcintl.cr.usgs.gov/downloads/sciweb1/shared/fews/web/africa/east/dekadal/emodis/ndvi_c6/temporallysmoothedndvi/downloads/dekadal/'      # East Africa
        # emodis__wa__roothttp    = settings.REMOTE_PATH__ROOT_HTTP__EMODIS__WA # 'https://edcintl.cr.usgs.gov/downloads/sciweb1/shared/fews/web/africa/west/dekadal/emodis/ndvi_c6/temporallysmoothedndvi/downloads/dekadal/'      # West Africa
        # emodis__sa__roothttp    = settings.REMOTE_PATH__ROOT_HTTP__EMODIS__SA # 'https://edcintl.cr.usgs.gov/downloads/sciweb1/shared/fews/web/africa/southern/dekadal/emodis/ndvi_c6/temporallysmoothedndvi/downloads/dekadal/'  # Southern Africa
        # emodis__cta__roothttp   = settings.REMOTE_PATH__ROOT_HTTP__EMODIS__CTA # 'https://edcintl.cr.usgs.gov/downloads/sciweb1/shared/fews/web/asia/centralasia/dekadal/emodis/ndvi_c6/temporallysmoothedndvi/downloads/dekadal/' # Central Asia
    ...
    def get_Month_Number_From_Dekadal(dekadal_string="01"):
        ...
        try:
            ...
            #monthNumber = ((dekadal_number - 1) / 3) + 1
            # ((36 - 1) / 3) + 1  // 12
        except:
            pass
        ...
        try:
            ...
            for expected_granules_object in expected_granules:
                try:
                    ...
                    # # Refactor_Port: This is handled in an Earlier Step
                    #
                    # # Based on the region string, set the region ID.
                    # if regionStr == 'ea':
                    #     regionID = 'EastAfrica'
                    # elif regionStr == 'wa':
                    #     regionID = 'WestAfrica'
                    ...
                    # else:
                    #     raise Exception('Unknown Region:' + regionStr)

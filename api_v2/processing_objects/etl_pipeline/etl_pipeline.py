...
class ETL_Pipeline():
    ...
    def execute_pipeline_control_function(self):
        ...
        # IMERG _1_Day Late
        if (current_Dataset_SubType == Config_Setting.get_value(setting_name="ETL_DATASET_SUBTYPE__IMERG_1_Day_LATE", default_or_error_return_value="imerg_1_day_late")):   # settings.ETL_DATASET_SUBTYPE__IMERG_LATE):
            # Create an instance of the subtype class - this class must implement each of the pipeline functions for this to work properly.
            self.Subtype_ETL_Instance = Subtype__ImergOneDay(self)
            # Imerg is special, requires setting which mode it is in

...
class ZMQCHIRPSHeadProcessor():
    ...
    def __init__(self, name, inputconn, outputconn, listenconn):
        ...
        print("logger.info: Creating Processor named: " + self.name + " listening on port: " + self.inputconn + " outputting to port: " + self.outputconn + "  listening for output on: " + self.listeningconn)
        ...
        print("ZMQCHIRPSHeadProcessor:  REFACTOR TODO: Add call to: self.__beginWatching__()")
...
# # # EXAMINING FOR REBUILDING - START

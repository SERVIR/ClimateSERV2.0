...
# Description:
# # Script to update the THREDDS server with the IMERG Early product data on a regular basis.
#
...
#DATASET_ID="WJzA2uQHJHhEwXHvTYiv"   # DEV
...
PREVIOUS_DAY=`expr $CURRENT_DAY - 1`

...
# Description:
# # Script to update the THREDDS server with the NDVI West Africa product data on a regular basis.
#
# Data Range:
...
# Dataset ID and Path
DATASET_ID="iDrphyYFjztchSQNvnfW"   # PROD
cd /cserv2/django_app/ClimateSERV-2.0-Server
#DATASET_ID="iDrphyYFjztchSQNvnfW"   # DEV
...
COMMAND="python3 manage.py start_etl_pipeline --etl_dataset_uuid $DATASET_ID --START_YEAR_YYYY $START_YEAR --START_MONTH_MM $START_MONTH --END_YEAR_YYYY $END_YEAR --END_MONTH_MM $END_MONTH --REGION_CODE wa"

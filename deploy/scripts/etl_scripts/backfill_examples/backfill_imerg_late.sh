...
python3 manage.py start_etl_pipeline --etl_dataset_uuid ggmNzrqfavjRPgyU2N2W --START_YEAR_YYYY 2020 --START_MONTH_MM 12  --START_DAY_DD 03 --START_30MININCREMENT_NN 01 --END_YEAR_YYYY 2020 --END_MONTH_MM 12  --END_DAY_DD 12 --END_30MININCREMENT_NN 48

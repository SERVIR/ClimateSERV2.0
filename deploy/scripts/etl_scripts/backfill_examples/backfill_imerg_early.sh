...
python3 manage.py start_etl_pipeline --etl_dataset_uuid WJzA2uQHJHhEwXHvTYiv --START_YEAR_YYYY 2019 --START_MONTH_MM 01  --START_DAY_DD 01 --START_30MININCREMENT_NN 01 --END_YEAR_YYYY 2021 --END_MONTH_MM 01  --END_DAY_DD 29 --END_30MININCREMENT_NN 48
